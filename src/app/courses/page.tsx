...
const page = () => {
  return (
    <div className="min-h-screen bg-black pb-20 pt-44">
            ...
            <CardBody className="bg-gray-50 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border  ">
              ...
              <CardItem translateZ="100" className="w-full mt-4">
                <Image
                  ...
                  height="1000"
                  width="1000"
                  className="h-60 w-full object-cover group-hover/card:shadow-xl rounded-lg border-2 border-transparent hover:border-white transition duration-300"
                  alt={course.title}
                />
              </CardItem>
